...
data <- matrix(c(0.2, 0.8, 0.5, 0.3, 0.6,
                 0.7, 0.3, 0.6, 0.5, 0.4,
                 0.4, 0.7, 0.3, 0.6, 0.5,
                 0.3, 0.6, 0.5, 0.4, 0.7,
                 0.6, 0.4, 0.7, 0.2, 0.8,
...
rownames(data) <- c("ICGs", "lncRNA", "miRNA", "Methylation", "Mutation")
colnames(data) <- c("Sample 1", "Sample 2", "Sample 3", "Sample 4", "Sample 5", "Sample N")

# Define color palette
color_palette <- colorRampPalette(c("#F2E94F", "#F5B700", "#26A782", "#3B5F8B", "#420D5A"))(100)
...
pheatmap(data, 
         ...
         legend_labels = c("Low", " ", " ", "High"),angle_col = 45,
         fontsize_row = 15,fontsize = 15,annotation_col = "lef")
...
p1 = pheatmap(data, 
              ...
              display_numbers = FALSE, 
              legend_breaks = c(0.2, 0.4, 0.6, 0.8), 
              legend_labels = c("Low", " ", " ", "High"),angle_col = 0,fontsize_row = 14,fontsize = 14)

#输出图形
ggsave("h.png",p1,height = 4.6,width = 7)
